							...
							<div class="col-sm-4">
								<div class="single-item">
									<div class="single-item-header">
										<a href="product.html"><img src="{{asset($a3->image)}}" alt=""></a>
									</div>
									<div class="single-item-body">
										<p class="single-item-title">{{$a3->name}}</p>
										<p class="single-item-price">
											<span>{{$a3->unit_price}}</span>
										</p>
									</div>
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="product.html"><i class="fa fa-shopping-cart"></i></a>
										<a class="beta-btn primary" href="{{route('detail',$a3->slug)}}">Details <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
						...
						<div class="widget-body">
							<div class="beta-sales beta-lists">
								...
								<div class="media beta-sales-item">
									<a class="pull-left" href="{{route('detail',$a3->slug)}}"><img src="{{asset($all4->image)}}" alt=""></a>
									<div class="media-body">
										{{$all4->name}}
										<span class="beta-sales-price">{{$all4->unit_price}}</span>
									</div>
								</div>
								@endforeach
							</div>
